...
export function PaywallPage() {
  ...
  //   Free    (10/день)  → 110 на сутки
  //   Basic   (50/день)  → 150 на сутки
  //   Premium (200/день) → 300 на сутки
  // Формулировки специально «разовые / одноразовая покупка / действует 24ч»
  // чтобы юзер не подумал что это +100 ежедневно навсегда.
  const dayPassFeaturesByTier: Record<'free' | 'basic' | 'premium', string[]> = {
    free: [
      '+100 сообщений (разово)',
      'Действует 24 часа от покупки',
      'Все 56+ персонажей',
      'Без подписки',
    ],
    basic: [
      '+100 сообщений (разово)',
      'Действует 24 часа от покупки',
      'Итого 150 на сутки (сверх Basic)',
      'Без подписки',
    ],
    premium: [
      '+100 сообщений (разово)',
      'Действует 24 часа от покупки',
      'Итого 300 на сутки (сверх Premium)',
      'Без подписки',
    ],
  }
